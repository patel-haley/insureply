...
interface FamilyPolicyRequestsProps {
  familyId: string;
  familyName: string;
}

const FamilyPolicyRequests: React.FC<FamilyPolicyRequestsProps> = ({ familyId, familyName }) => {
  ...
  return (
    <div>
      <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
        ...
        Policy Requests for {familyName} ({requests.length})
      </h3>
      ...
      {requests.length > 0 ? (
        ...
        <div className="text-center py-8">
          ...
          <p className="text-gray-600">No policy requests found for this family.</p>
        </div>
      )}
...
export default FamilyPolicyRequests;